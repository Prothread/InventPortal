...
?>
    ...
    <div class="crm-content-view-wrapper-2">
        <div class="view-content">
            <h1 class="crm-content-header"><?= TASK_OVERVIEW ?><?php if(isset($finished)){echo TEXT_HEADER_FINISHED;}elseif (isset($deleted)){echo TEXT_HEADER_DELETED;};?></h1>
                    ...
                    >
                        ...
                        foreach ($users as $u) {
                            ...
                            if ($post && $u['id'] == $_POST['userId']) {
                                echo 'selected';
                            } elseif (!$post && $u['id'] == $taskinfo['user']) {
                                echo 'selected';
                            }
                            echo '>' . $u['naam'] . '</option>';
                        }

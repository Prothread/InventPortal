            ...
            <div class="col-lg-12">
                ...
                <div style="height:100%;width:100%;border:1px solid #ccc;font:16px/26px Cabin; overflow:auto;">
                    <div id="ConditionsLogoDiv">
                        <img src="http://www.madalcomedia.nl/wp-content/themes/madalcomedia/img/logo.svg" class="ConditionsLogo"><br>
...
a.  Beroepsregelgeving: de beroeps- en gedragsregels waaraan de accountant vanwege de inschrijving in het accountantsregister van de NBA is onderworpen;

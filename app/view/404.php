...
<div id="error404">
    <div class="error">
        <br /><br /><br /><br /><br />
        <div style="color: #dd2c4c; font-family: 'Abhaya Libre', serif; color:" class="error-code m-b-10 m-t-20">Oeps!<i class="fa fa-warning"></i></div>
        ...
        <div style="color: #000; font-family: 'Open Sans', sans-serif; font-size: 20px;" class="error-desc">
            ...
            <div>
                ...
                <a class=" login-detail-panel-button btn" href="#">
                    <a href="?page=dashboard" style="font-family: 'Abhaya Libre', serif; font-size: 25px; color: #dd2c4c" class="btn btn-lg btn-default">Homepagina</a>
                </a>
            </div>
        </div>
    </div>

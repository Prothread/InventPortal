                ...
                <form role="form" method="post" name="signupform">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="cpassword" placeholder="Nieuw wachtwoord"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="newcpassword" placeholder="Nieuw wachtwoord" required
                                   class="form-control"/>
                            <span
                                class="text-danger"><?php if (isset($cpassword_error)) echo $cpassword_error; ?></span>
                        </div>

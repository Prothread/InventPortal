...
define("TEXT_FILTER_OPTION", "Filter option");
...
define("TEXT_VALIDITY_DURATION","Validity duration (days)");
define("TEXT_VALUE","Value (&#8364;)");
define("TEXT_VALUE_TEXT", "Value");
...
define("YOUR_TENDER", "Your tenders");
define("TENDER_OVERVIEW_TEXT", "Tenders overview");
define("CASES_OVERVIEW_TEXT", "Cases overview");
define("YOUR_PROJECT", "Your projects");
define("YOUR_ASSIGNMENT", "Your assignments");
define("YOUR_TASK", "Jouw tasks");
define("YOUR_CASE", "Your cases");
define("OPEN_TENDERS", "Open tenders");
define("OPEN_PROJECTS", "Open projects");
define("OPEN_ASSIGNMENTS", "Open assignments");
define("OPEN_TASKS", "Open tasks");
